...
def main():
    ...
    # ---- Protein inference stage ----
    pi = pipeline["protein_inference"]
    ...
    if pi == "philosopher_proteinprophet":
        ...
        cmd = [
            ...
            "--taxonomy-index", str(taxonomy_index),
    ...
    # ---- Evaluation ----
    pipeline_metrics = root / "pipeline_metrics.json"
    if truth:
        run([
            "python",
    ...
    manifest = {
        ...
        "outputs": {
            ...
            "protein_groups": str(protein_groups),
